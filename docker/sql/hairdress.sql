...
INSERT INTO `cmf_admin_menu` VALUES (110,0,1,1,10000,'admin','User','index','','管理员','newspaper-o','管理员管理'),(162,0,1,1,10000,'admin','WxUserInfo','index','','微信用户','wechat','微信用户管理'),(163,0,1,1,10000,'admin','order','index','','订单管理','','订单管理');
...
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=utf8mb4 COMMENT='权限规则表';
/*!40101 SET character_set_client = @saved_cs_client */;
