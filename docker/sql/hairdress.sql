...
INSERT INTO `cmf_admin_menu` VALUES (110,0,1,1,10000,'admin','User','index','','管理员','newspaper-o','管理员管理'),(162,0,1,1,10000,'admin','WxUserInfo','index','','微信用户','wechat','微信用户管理');
...
-- Dump completed on 2018-02-27 16:02:46
