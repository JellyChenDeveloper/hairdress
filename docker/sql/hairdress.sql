...
INSERT INTO `cmf_user` VALUES (1,1,0,0,1520605284,0,0,0.00,1517667595,1,'admin','###b0e6dcf3e0cc1923339b92d115e6bcc1','admin','1@1.com','','','','172.21.0.1','','',NULL),(2,1,0,0,1520075935,0,0,0.00,0,0,'admin2','###949505e3c19e695eefbb70fb3197dfc4','','3@3.com','','','','172.21.0.1','','',NULL);
...
CREATE TABLE `hair_element` (
  ...
  PRIMARY KEY (`id`),
  KEY `alias` (`alias`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='组件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hair_element` VALUES (1,'组件1','zujian1','/page/18-03-10/页面_1520672480.png','/page/18-03-10/页面_1520672480.png',0,1,0,2,1,NULL,0,1520679576,1520679576);
...
INSERT INTO `hair_pages` VALUES (4,1,4,'页面','/page/18-03-10/页面_1520681200.png','',1,10000,NULL,1520579822,1520681201,0);
...
-- Dump completed on 2018-03-11 10:30:22
