...
INSERT INTO `cmf_admin_menu` VALUES (1,0,1,1,10000,'admin','User','index','','管理员','newspaper-o','管理员管理'),(2,0,1,1,10000,'admin','WxUserInfo','index','','微信用户','wechat','微信用户管理'),(3,0,1,1,10000,'admin','order','index','','订单管理','envelope-o','订单管理'),(4,0,1,1,10000,'admin','element','index','','组件管理','cubes',''),(5,0,1,1,10000,'admin','ActivityCode','index','','激活码管理','check-square-o',''),(6,0,1,1,10000,'hair','AdminTransfer','index','','返现管理','credit-card',''),(7,0,1,1,10000,'hair','AdminCourse','Index','','教程管理','book','教程管理');
...
INSERT INTO `hair_activity_code` VALUES (1,0,0,'88888888','8888',1,25,5,3,1,10000,NULL,1521914654,1521914654,0);
...
INSERT INTO `hair_pages` VALUES (1,1,1,'页面','page/20180325/bd5730e1f809fad960386468fc1bafeb.png','',1,10000,NULL,1521914794,1521914821,0),(2,2,2,'经典1','page/20180326/781b6fdf3aecd7fda9c7742534ae68b9.png','',1,10000,NULL,1521958077,1522036933,0),(3,3,3,'页面','','',1,10000,NULL,1522143674,1522143674,0);
...
INSERT INTO `hair_projects` VALUES (1,1,'项目','',1,10000,NULL,1521914789,1521914789,0),(2,2,'经典','',1,10000,NULL,1521958025,1521958025,0),(3,3,'项目','',1,10000,NULL,1522143668,1522143668,0);
...
CREATE TABLE `hair_wechat_user` (
  ...
  KEY `mobile` (`mobile`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='微信用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-03-27 22:40:50
